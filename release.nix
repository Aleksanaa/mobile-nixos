...
rec {
  ...
  installer = {
    ...
    lenovo-mrbland = (evalInstaller { device = "lenovo-mrbland"; localSystem = "aarch64-linux"; }).outputs.default;
  ...
  cross-compiled = {
    installer = {
      ...
      lenovo-mrbland = (evalInstaller { device = "lenovo-mrbland"; localSystem = "x86_64-linux"; }).outputs.default;
